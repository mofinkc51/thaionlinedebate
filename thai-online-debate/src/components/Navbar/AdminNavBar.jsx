            ...
            <ul class="nav-menu" id="myMenu">
              ...
              {location.pathname === "/" && (
                <li className="nav-menu-home">
                  <a onClick={createTopicForm}>สร้าง</a>
                </li>
              )}
              <li>
                <a href="/manage/main">เมนู</a>
              ...
              <div class="nav-dropdown">
                <li className="nav-dropdown">
                  <a class="nav-dropbtn" href="">
                    {currentUser.user_name} <FaAngleDown />
                  </a>
                </li>
                <div class="nav-dropdown-content">
                  ...
                  <a className="nav-dropdown-a" href="/fav">
                    รายการประเด็นโต้แย้งที่ชื่นชอบ
                  </a>
                  <a className="nav-dropdown-a" href="/downloadrequest">
                    ส่งคำร้องขอชุดข้อมูล
                  </a>
                  <a className="nav-dropdown-a" href="/historydownload">
                    ประวัติคำร้องขอชุดข้อมูล
                  </a>
                  <a className="nav-dropdown-signout" href="/" onClick={logout}>
                    ออกจากระบบ
                  </a>
                </div>
              </div>
