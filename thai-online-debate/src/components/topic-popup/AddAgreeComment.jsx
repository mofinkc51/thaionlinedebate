  ...
  const addCommentAgree = async (e) => {
    ...
    if (!special_char(dataComment.dbc_comment)) {
      ...
      Swal.fire({
        ...
        title: "Oops...",
        text:
          "ข้อความโต้แย้งต้องมีความยาวอย่างน้อย " +
          3 +
          " ตัวอักษรและไม่เกิน " +
          150 +
          " ตัวอักษร",
        ...
        <div className="add-comment-popup-box">
          <div className="add-comment-popup-container">
            ...
            <form onSubmit={addCommentAgree}>
              ...
              <textarea
                className="add-comment-popup-input"
                name="dbc_comment"
                ...
                required
              ></textarea>
              <div className="add-comment-caution">
                <IoIosInformationCircleOutline />
                <p>หากพบข้อความโต้แย้งที่ไม่เหมาะสม จะถูกลบโดยผู้ดูแลระบบ</p>
              </div>
            ...
            <div className="add-comment-close-button-box">
              <button
                className="add-comment-close-button"
